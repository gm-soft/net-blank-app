...
describe('DateExtended', () => {
  ...
  it('.addDays() cases. Positive days number', () => {
    expect(
      target('2020-07-15')
        .addDays(2)
        .sameDay(target('2020-07-17'))
    ).toBe(true);
    expect(
      target('2020-07-15')
        .addDays(2)
        .sameDay(target('2020-07-16'))
    ).toBe(false);
    expect(
      target('2020-07-15')
        .addDays(2)
        .sameDay(target('2020-07-14'))
    ).toBe(false);

    expect(
      target('2020-07-30')
        .addDays(2)
        .sameDay(target('2020-08-01'))
    ).toBe(true);
    expect(
      target('2020-07-30')
        .addDays(2)
        .sameDay(target('2020-07-31'))
    ).toBe(false);
    expect(
      target('2020-07-30')
        .addDays(2)
        .sameDay(target('2020-07-02'))
    ).toBe(false);
  });
  ...
  it('.addDays() cases. Negative days number', () => {
    expect(
      target('2020-07-15')
        .addDays(-2)
        .sameDay(target('2020-07-13'))
    ).toBe(true);
    expect(
      target('2020-07-15')
        .addDays(-2)
        .sameDay(target('2020-07-12'))
    ).toBe(false);
    expect(
      target('2020-07-15')
        .addDays(-2)
